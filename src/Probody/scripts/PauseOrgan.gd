...
func _physics_process(_delta):
	...
	if Input.is_action_just_pressed("ui_cancel") and Global.tutorialFinished: 
		$PauseScreen/ReturnButton.grab_focus()
...
func _on_ReturnButton_pressed():
	...
	visible = not visible
	Input.set_custom_mouse_cursor(Global.organMouse) # Muda o cursor original para o de metabolismo
